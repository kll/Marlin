...
#define STRING_CONFIG_H_AUTHOR "(kll, SKR 1.4 TFT35 3.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BNBSX"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Autotune result
  #define DEFAULT_Kp 53.11
  #define DEFAULT_Ki 6.12
  #define DEFAULT_Kd 115.22
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 89.61
  #define DEFAULT_bedKi 11.14
  #define DEFAULT_bedKd 480.51
#endif // PIDTEMPBED
 ...
 * Override with M203
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 * KLL E feedrate calibrated 2020-08-18
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 12, 750 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 400, 400, 15, 750 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2500, 2500, 50, 10000 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -0.95 }
